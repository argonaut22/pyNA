...
class CLCD(om.MetaModelStructuredComp):
    ...
    * ``outputs['c_d']``:                aircraft drag coefficient [-]
    ...
    def initialize(self):
        ...
        self.options.declare('method', values=TABLE_METHODS, default='scipy_slinear', desc='Spline interpolation method to use for all outputs.')        
    ...
    def setup(self):
        ...
        self.options["method"] = 'scipy_cubic'
